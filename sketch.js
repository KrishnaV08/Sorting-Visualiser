...
function darkmode() {
  ...
  switch (mode.value) {
    case "off":
      ...
      gitlogo1.style.color = "white";
      gitlogo2.style.color = "white";

      document.body.style.backgroundImage =
        "linear-gradient(to right,#121212,#121212)";
      mode.value = "on";
      break;

    case "on":
      footer.style.backgroundColor = "#B0A695";
      card.style.backgroundColor = "#eee7da";
      cardbody.style.backgroundColor = "#eee7da";
      cardbody.style.color = "black";
      arrinfotxt.style.color = "black";
      card2.style.backgroundColor = "#eee7da";
      cardbody2.style.backgroundColor = "#eee7da";
      cardbody2.style.color = "black";
      nav1.style.backgroundColor = "#b0a695";
      nav1.style.color = "black";
      navbarbrand.style.color = "black";
      gitlogo1.style.color = "black";
      gitlogo2.style.color = "black";
      document.body.style.backgroundImage =
        "linear-gradient(to right,#3A4D39, #3A4D39)";
      mode.value = "off";
      break;
  }
}
